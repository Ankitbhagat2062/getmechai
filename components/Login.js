...
const LoginComponent = () => {
    ...
    return (
        <div className='text-white py-14 container mx-auto '>
            <h1 className='font-bold text-3xl text-center'>Login/SignUp to get Your Fans support You</h1>
            <div className="social-login-buttons">
                <div className="flex flex-col gap-2 items-center justify-center p-10">
                    <button
                        className="flex items-center border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm 
                        font-medium text-gray-800 bg-gray-200 w-60 cursor-pointer 
                    ...
                    <button
                        className="flex items-center  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 bg-gray-200 w-60 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <button
                        className="flex items-center  border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium
                         text-gray-800 bg-gray-200 w-60 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
